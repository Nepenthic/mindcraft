export default 
{
    "minecraft_version": "1.21.4", // Updated to match actual server version
    "host": "127.0.0.1", // or "localhost", "your.ip.address.here"
    "port": process.env.MINECRAFT_PORT || 25565,
    "auth": "offline", // or "microsoft"
    "username": "MinecraftAI", // Changed from GrokBot to MinecraftAI
    "connect_timeout": 60000, // Added longer timeout for connection
    ...
    "chat_patterns": {
        "chat": [
            {"regex": "^<(?:\\w+)> (.+)$", "type": "chat"},
            {"regex": "^\\[(?:\\w+)\\] (.+)$", "type": "chat"},
            {"regex": "^(?:[\\w\\s]+) says: (.+)$", "type": "chat"},
            {"regex": "^(?:\\w+) (?:whispers to you:|tells you:|-> me): (.+)$", "type": "whisper"},
            {"regex": "^\\[(?:\\w+) -> me\\] (.+)$", "type": "whisper"}
        ]
    },
